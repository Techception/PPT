...
task3 = """ If the person is at least 13 years old but less than 20, print a 
    message that the person is a teenager.
"""

task4 = """ If the person is at least 20 years old but less than 65, print a 
    message that the person is an adult.
"""

task5 = """If the person is age 65 or older, print a messeage that the person 
    is an elder.
"""
